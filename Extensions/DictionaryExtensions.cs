...
namespace LevelUpper.Extensions {
	public static class DictionaryExtensions {
		...
		public static HashSet<T> GetKeySet<T, K>(this Dictionary<T, K> d) {
		...
		public static void LoadCSV(this Dictionary<string, HashSet<string>> d, string csv) { d.LoadCSV(csv, ','); }
		public static void LoadCSV(this Dictionary<string, HashSet<string>> d, string csv, char delim) { 
			d.Clear();
			string[] lines = csv.Split('\n');
